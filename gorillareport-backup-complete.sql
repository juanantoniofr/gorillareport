...
CREATE TABLE `clients` (
  ...
  `information` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '{}' CHECK (json_valid(`information`)),
...
INSERT INTO `clients` VALUES (1,'2023-03-09 08:19:48','2023-03-09 09:05:24','px-pstman-testing','192.168.2.3','{}',NULL,'asdasd3423asdad'),(2,'2023-03-09 09:37:57','2023-03-09 09:37:57','pc101_IntelH310','10.1.21.50','{}',NULL,'90D73018-128A-30EE-868F-3C7C3F292A95'),(3,'2023-04-16 08:10:15','2023-04-16 08:14:31','PAJARITO','{\r\n  \"192.168.56.1\",\r\n  \"169.254.216.134\",\r\n  \"169.254.107.61\",\r\n  \"169.254.30.175\",\r\n  \"192.168.1.104\"\r\n}','{\r\n    \"WindowsInfo\":  {\r\n                        \"OSName\":  \"Microsoft Windows 10 Home\",\r\n                        \"Build\":  \"19044\",\r\n                        \"Version\":  \"10.0.19044\",\r\n                        \"InstallDate\":  \"\\/Date(1605957915000)\\/\"\r\n                    },\r\n    \"SystemInfo\":  {\r\n                       \"RAMInstalledGB\":  8,\r\n                       \"SystemType\":  \"64 bits\",\r\n                       \"Processor\":  \"Intel(R) Core(TM) i5-8265U CPU @ 1.60GHz\"\r\n                   }\r\n}',NULL,'25156437-3F2C-8B40-AA61-95A6B6473E3C');
...
INSERT INTO `model_has_roles` VALUES (1,'App\\Models\\User',1),(1,'App\\Models\\User',4),(1,'App\\Models\\User',6);
...
CREATE TABLE `reports` (
  ...
  `managed_install` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`managed_install`)),
  `managed_uninstall` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`managed_uninstall`)),
  `managed_update` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`managed_update`)),
  PRIMARY KEY (`id`),
...
-- Dump completed on 2023-04-16 13:40:50
